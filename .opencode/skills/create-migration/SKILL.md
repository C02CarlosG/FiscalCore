...
1. **Encuentra el número siguiente**: Lee los archivos en `database/migrations/` y detecta el número más alto. El siguiente es ese número + 1, con cero a la izquierda de dos dígitos mínimo (019, 020, 021...).
