...
3. **Genera el archivo de tests**: `tests/test_<nombre_router>.py`
...
Confirma: "Tests generados en `tests/test_<nombre>.py` — N endpoints × 3 tests = N tests en total."
Muestra el comando para correrlos: `.venv/bin/python -m pytest tests/test_<nombre>.py -v`
